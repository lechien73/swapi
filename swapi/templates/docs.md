...
Open up a terminal and use [curl](http://curl.haxx.se) or [httpie](http://httpie.org) to make an API request for a resource. In the example below, we're trying to get the first planet, Tatooine:
    ...
    http ci-swapi.herokuapp.com/api/planets/1/
...
```
https://ci-swapi.herokuapp.com/api/people/?search=r2
```
...
```
https://ci-swapi.herokuapp.com/api/planets/1/?format=wookiee
```
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/people/1/
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/films/1/
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "planets": [
            "https://ci-swapi.herokuapp.com/api/planets/1/",
            ...
        ],
        ...
        "starships": [
            "https://ci-swapi.herokuapp.com/api/starships/2/",
            ...
        ],
        "title": "A New Hope",
        "url": "https://ci-swapi.herokuapp.com/api/films/1/",
        "vehicles": [
            "https://ci-swapi.herokuapp.com/api/vehicles/4/",
            ...
        ]
    }
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/starships/9/
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "url": "https://ci-swapi.herokuapp.com/api/starships/9/"
    }
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/vehicles/4/
...
**Example response:**
...

    {
        ...
        "url": "https://ci-swapi.herokuapp.com/api/vehicles/4/",
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/species/3/
...
**Example response:**
...

    {
        ...
        "name": "Wookie",
        "people": [
            "https://ci-swapi.herokuapp.com/api/people/13/"
        ],
        "films": [
            "https://ci-swapi.herokuapp.com/api/films/1/",
...
**Example request:**
    ...
    http https://ci-swapi.herokuapp.com/api/planets/1/
